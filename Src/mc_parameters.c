...
/* PWM Driving signals initialization ----------------------------------------*/
  ...
  .ADCConfig1 = {   MC_ADC_CHANNEL_7<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_6<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_6<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_6<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_6<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_7<<ADC_JSQR_JSQ4_Pos
                  },

  .ADCConfig2 = {   MC_ADC_CHANNEL_14<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_14<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_14<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_7<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_7<<ADC_JSQR_JSQ4_Pos
                   ,MC_ADC_CHANNEL_14<<ADC_JSQR_JSQ4_Pos
